...
class PaysControllerTest < ActionController::TestCase
  ...
  test "should create pay" do
    assert_difference('Pay.count') do
      post :create, pay: { capitale: @pay.capitale, devise: @pay.devise, habitants: @pay.habitants }
    end
  ...
  test "should update pay" do
    patch :update, id: @pay, pay: { capitale: @pay.capitale, devise: @pay.devise, habitants: @pay.habitants }
    assert_redirected_to pay_path(assigns(:pay))
  end
